...
class UpgradableTest {
    private static Upgradable upgradable;
    private static ZapCoordinator coordinator;

    @BeforeAll
    static void testDeployUpgradable() throws Exception {
        ...
        upgradable = Upgradable.deploy(web3j, creds, gasPro, coordinator.getContractAddress()).send();
    }
