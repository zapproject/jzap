...
class CurrentCostTest {
    private static CurrentCost currentCost;
    private static ZapCoordinator coordinator;

    @BeforeAll
    static void testDeployCurrentCost() throws Exception {
        ...
        currentCost = CurrentCost.deploy(web3j, creds, gasPro, coordinator.getContractAddress()).send();
    }
