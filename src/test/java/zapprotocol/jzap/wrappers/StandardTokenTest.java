...
class StandardTokenTest {
    private static StandardToken standardToken;

    @BeforeAll
    static void testDeployStandardToken() throws Exception {
        ...
        standardToken = StandardToken.deploy(web3j, creds, gasPro).send();
    }
