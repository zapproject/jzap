...
class FactoryTokenTest {
    private static FactoryToken factoryToken;

    @BeforeAll
    static void testDeployFactoryToken() throws Exception {
        ...
        factoryToken = FactoryToken.deploy(web3j, creds, gasPro, "", "").send();
    }
