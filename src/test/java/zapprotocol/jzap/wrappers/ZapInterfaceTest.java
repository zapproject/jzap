...
class ZapInterfaceTest {
    private static ZapInterface zapInterface;

    @BeforeAll
    static void testDeployZapInterface() throws Exception {
        ...
        zapInterface = ZapInterface.deploy(web3j, creds, gasPro).send();
    }
