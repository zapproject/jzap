...
class BondageTest {
    ...
    void testBondageDelegateBond() throws Exception {
        assertNotNull(bondage.delegateBond(creds2.getAddress(), creds.getAddress(), endpoint, new BigInteger("10")).send());
    }
    ...
    void testBondageIsProviderInitiated() throws Exception {
        assertNotNull(bondage.isProviderInitialized(creds.getAddress(), creds.getAddress()).send());
    }

    @Test
    @Order(12)
    void testBondageGetEndpointBroker() throws Exception {
        assertNotNull(bondage.getEndpointBroker(creds.getAddress(), endpoint).send());
    }

    @Test
    @Order(13)
    void testBondageGetNumEscrow() throws Exception {
        assertNotNull(bondage.getNumEscrow(creds.getAddress(), creds.getAddress(), endpoint).send());
    }

    @Test
    @Order(13)
    void testBondageGetNumZap() throws Exception {
        assertNotNull(bondage.getNumZap(creds.getAddress(), endpoint).send());
    }

    @Test
    @Order(14)
    void testBondageGetDotsIssued() throws Exception {
        assertNotNull(bondage.getDotsIssued(creds.getAddress(), endpoint).send());
    }

    @Test
    @Order(15)
    void testBondageGetBoundDots() throws Exception {
        assertNotNull(bondage.getBoundDots(creds.getAddress(), creds.getAddress(), endpoint).send());
    }

    @Test
    @Order(16)
    void testBondageGetIndexSize() throws Exception {
        assertNotNull(bondage.getIndexSize(creds.getAddress()).send());
    }
