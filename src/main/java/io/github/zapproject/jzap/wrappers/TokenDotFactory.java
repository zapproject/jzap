...
public class TokenDotFactory extends BaseContract {
    ...
    /**
     * Constructor of TokenDotFactory
    ...
    /**
     * Listens to bounded events
     * @param   transactionReceipt Log of transactions done with Bondage contract
     * @return  List of bounded events
     */
     ...
     * @return  List of token created events
     */
    ...
    /**
     * Listens to unbounded events
     * @param   transactionReceipt Log of transactions done with contract
     * @return  List of unbounded events
     */
    ...
    /**
     * Unbound Dots from Token endpoint
     * @param   specifier
     * @param   numDots
     */
     ...
     * @param   endpoint
     * @return  A remote function call which returns the token address
     */
    ...
    /**
     * Wrapper to initialize a deploted TokenDotFactory contract
     * @param   contractAddress     Address of deployed contract
     * @param   web3j               Instance of Web3j interacting with contracts
     * @param   credentials         Credentials account data
     * @param   contractGasProvider Contract gas data
     * @return  TokenDotFactory contract
     */
    ...
    /**
     * Wrapper to initialize a deployed TokenDotFactory contract
     * @param   type Wrapper class NetworkProviderOptions for {int networkID, org.web3j.protocol.Web3j web3j, org.web3j.crypto.Credentials credentials, org.web3j.tx.gas.ContractGasProvider contractGasProvider}
     * @return  TokenDotFactory contract
     */
    ...
    /**
     * Deploys a new TokenDotFactor contract for testing
     */
    ...
    /**
     * Wrapper object for bonded events
     */
    ...
    /**
     * Wrapper object for dot token created events
     */
    ...
    /**
     * Wrapper object for unbonded events
     */
