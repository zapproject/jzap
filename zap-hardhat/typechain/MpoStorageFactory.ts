...
export class MpoStorageFactory extends ContractFactory {
  constructor(signer?: Signer) {
    super(_abi, _bytecode, signer);
  }

  deploy(overrides?: Overrides): Promise<MpoStorage> {
  ...
  connect(signer: Signer): MpoStorageFactory {
    return super.connect(signer) as MpoStorageFactory;
  }
  static connect(
    address: string,
