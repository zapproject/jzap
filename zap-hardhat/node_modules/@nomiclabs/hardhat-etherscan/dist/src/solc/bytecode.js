...
exports.compile = exports.zeroOutSlices = exports.normalizeBytecode = exports.compareBytecode = exports.lookupMatchingBytecode = void 0;
const task_names_1 = require("hardhat/builtin-tasks/task-names");
const contract_names_1 = require("hardhat/utils/contract-names");
const metadata_1 = require("./metadata");
const version_1 = require("./version");
/**/
async function lookupMatchingBytecode(contractBuilds, deployedBytecode, inferralType) {
...
async function compile(taskRun, matchingVersions, artifactsPath, artifacts) {
    await taskRun(task_names_1.TASK_COMPILE);
    const contractBuildInfos = [];
    ...
    for (const name of fqns) {
        ...
        const { sourceName, contractName } = contract_names_1.parseFullyQualifiedName(name);
