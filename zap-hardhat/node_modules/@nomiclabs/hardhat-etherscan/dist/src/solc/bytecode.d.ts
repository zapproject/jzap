...
export declare function lookupMatchingBytecode(contractBuilds: ContractBuildInfo[], deployedBytecode: string, inferralType: InferralType): Promise<{
...
export declare function compile(taskRun: RunTaskFunction, matchingVersions: string[], artifactsPath: string, artifacts: Artifacts): Promise<ContractBuildInfo[]>;
export {};
